# AWS Module Release 2.0.0

Welcome to the latest release of `aws` module of the [`SIGHUP Distribution`](https://github.com/sighupio/fury-distribution) maintained by team SIGHUP.
...
This release completely removes all the terraform modules used for the installation of a Kubernetes cluster using EC2. SIGHUP Distribution has deprecated support for EC2-based clusters in favour of EKS (managed) clusters.
